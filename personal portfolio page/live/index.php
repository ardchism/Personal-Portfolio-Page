...
if($_POST["name"]) {
	...
	if($_POST["email"]){
		...
		if($_POST["message"]){
			if (mail("ardchism@icloud.com", $_POST["name"], $_POST["message"], "From: ".$_POST["email"])){
	
		
			} else {
		
				$error = "Error occured when sending the email!";
		
			}
		}
		else{
			$error = '<label><span class="label label-danger">Please enter a message</span></label>';
		}
	}
	else{
		$error = '<label><span class="label label-danger">Please enter an email</span></label>';
	}
}
else{
	$error = '<label><span class="label label-danger">Please enter a name</span></label>';
} 
		...
		<div class="row">
			<div class="col-md-6 col-md-offset-3" id="topRow">
				...
				<ul class="list-group">
					...
					<li class="list-group-item">My Web Applications use HTML 5, JavaScript, CSS3, JQuery, PHP, and Twitter Bootstrap.</li>
				</ul>
							...
							<div class="panel-body">
								<form class="form-horizontal" method="post">
									...
									<div class="form-group">
										...
										<input class="form-control" id="email" name="email" type="email" placeholder="****@abc.net" value="<?php echo $_POST['email']; ?>"/>
									</div>
			
									<div class="form-group">
										<textarea class="form-control" rows="3" id="message" name="message" placeholder="Enter Message Here"><?php echo $_POST['message']; ?></textarea>
									</div>
	...
	<div class="container" id="secondContainer">
		...
		<div class="row" id="rowOne">
			...
			<div class="col-md-6 col-md-offset-3" id="utdallas">
				...
				<h2 id="UTDtext">Bachelor of Science in Management Information Systems</h2>
		...
		<div class="row" id="rowTwo">
			...
			<div class="col-md-6 col-md-offset-3" id="CPPinstitute">
				...
				<a href="CppInstituteCertificate.pdf">
